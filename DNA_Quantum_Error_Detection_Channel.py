...
def experiment3_complete_detection_mega_figure():
    ...
    axes[0, 0].plot(p_values, x_rates, 'b-', linewidth=2.5, marker='o', markersize=7, label='Simulated')
    ...
    axes[0, 1].plot(p_values, y_rates, 'g-', linewidth=2.5, marker='s', markersize=7, label='Simulated')
    ...
    axes[1, 0].plot(p_values, z_rates, 'm-', linewidth=2.5, marker='^', markersize=7, label='Simulated')
